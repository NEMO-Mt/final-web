...
<body class="bg-bg_main font-sans text-primary min-h-screen flex flex-col">
    ...
    <main class="flex-grow p-4 md:p-8 flex justify-center pb-20">
        <div class="bg-white rounded-[30px] p-8 md:p-12 w-full max-w-3xl shadow-sm border border-gray-100">
            <h2 class="text-center font-bold text-2xl mb-8">สร้างกิจกรรมใหม่</h2>
            ...
            <form method="POST" action="/create" enctype="multipart/form-data" class="space-y-6">
                <div>
                    ...
                    <div class="border-2 border-dashed border-secondary bg-surface/50 rounded-2xl p-6 flex flex-col items-center justify-center cursor-pointer hover:bg-surface transition" onclick="document.getElementById('images').click()">
                        ...
                        <span class="text-sm text-primary mb-2">คลิกเพื่อเลือกรูปภาพ</span>
                ...
                <div>
                    ...
                    <input type="text" name="title" required class="w-full border border-gray-200 rounded-xl px-4 py-3 outline-none focus:border-primary focus:ring-1 focus:ring-primary transition text-sm placeholder-gray-400">
                </div>

                <div>
                    <label class="block font-bold mb-2">รายละเอียดกิจกรรม <span class="text-red-500">*</span></label>
                    <textarea name="detail" rows="4" required class="w-full border border-gray-200 rounded-xl px-4 py-3 outline-none focus:border-primary focus:ring-1 focus:ring-primary transition text-sm placeholder-gray-400 resize-none"></textarea>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="location" required placeholder="เช่น คณะ IT-MSU" class="w-full border border-gray-200 rounded-xl pl-10 pr-4 py-3 outline-none focus:border-primary transition text-sm placeholder-gray-400">
                    </div>
                </div>
                ...
                <div class="flex gap-4 pt-4">
                    ...
                    <a href="/home" class="flex-1 bg-gray-200 hover:bg-gray-300 text-gray-700 font-bold py-3 rounded-2xl transition text-center">
                        ยกเลิก
                    </a>
                </div>
            </form>
